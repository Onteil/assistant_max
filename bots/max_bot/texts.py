...
Опишите свой запрос словами, чтобы получить консультацию или оформить обращение,
либо нажмите подходящую кнопку. Можно пользоваться обоими способами.
...
# MAX form wording; Telegram keeps its existing keyboard labels.
CONVERSATION_HINT = (
    "\nМожно отвечать сообщениями или пользоваться кнопками. "
    "Чтобы выйти из оформления и описать новый запрос, напишите «отмена» или /start.\n"
)
INVOICE_SELECT_ORGANIZATION += CONVERSATION_HINT
SUPPORT_SELECT_ORGANIZATION += CONVERSATION_HINT
CONSULTATION_SELECT_ORGANIZATION += CONVERSATION_HINT
INVOICE_SELECT_KEYS = """
<b>📄 Получение счёта</b>
...
Нажмите на ключ, чтобы выбрать/отменить выбор, или напишите номер ключа.
После выбора ключей нажмите «Далее» или напишите «далее».
Если ключ указывать не нужно, тоже нажмите «Далее».
"""
INVOICE_KEY_ADDED = "✅ Ключ добавлен! Продолжите выбор ключей или нажмите «Далее»."
INVOICE_ENTER_DESCRIPTION = """
<b>📄 Получение счёта</b>

Шаг 3/4. Что нужно включить в счет?

При желании добавьте комментарий своими словами или прикрепите файл.
Пример: обновление базы ФСНБ и подписка на ИТС.
Затем нажмите «Далее» или напишите «далее». Можно продолжить без комментария.
"""
