...
class YandexGPTService:
    ...
    async def classify_menu_navigation(self, user_text: str) -> MenuNavigationIntent:
        ...
        allowed_actions = {
            ...
            "renewal": "пользователь явно хочет открыть активацию подписки на техподдержку ИТС",
            "subscription_lookup": "пользователь хочет узнать подписки по ключу ГРАНД-Сметы, годовые подписки на программу или базы; это НЕ активация подписки на техподдержку",
