...
class CalendarFormatter:
    ...
    def format_rule_list(
        ...
        lines.append("• <code>21 марта рабочее время с 8:30 до 17:00</code>")
    ...
    def format_command_examples(self) -> str:
        ...
        lines = [
            ...
            "• <code>1 февраля рабочее время с 8:30 до 17:00</code>",
            "  <i>Офисный режим с точным временем</i>",
            ...
            "• <code>с 1 по 5 марта продленное рабочее время с 18:30 до 22:15</code>",
            "  <i>Дежурство с точным временем</i>\n",
            "<b>Удалить правило:</b>",
            ...
            "<b>Форматы времени:</b>",
            "• Только часы: <code>9</code>, <code>17</code> (означает 09:00, 17:00)",
            "• С ведущим нулем: <code>09</code>, <code>08</code>",
            "• Час:минуты: <code>8:30</code>, <code>17:00</code>, <code>23:45</code>",
            "• Смешанные: <code>с 8:30 до 17</code>, <code>с 9 до 18:15</code>",
            "• Ночные смены: <code>с 23:00 до 01:00</code> (через полночь)"
        ]
